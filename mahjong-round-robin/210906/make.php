...
<form action = "make.php" method="post">
 ...
 <dl>
 <dt>対戦表ID</dt>
<dd><input type="text" name="id" size="15" maxlength="16" /></dd>
 <dt>タイトル</dt>
...
<dt>プレイヤーの順番は対戦表作成時にランダムに変更されます。</dt>
 ...
 <dt> 点数計算</dt>
<dd> 持ち点：<input type="text" name="first_score" size="3" maxlength="4" style="text-align:right" value="250" />00 (最大100,000点)</dd>
...
<dd> 順位点：<input type="text" name="rank1" size="3" maxlength="5" style="text-align:right" value="300" />00-<input type="text" name="rank2" size="3" maxlength="5" style="text-align:right" value="100" />00-<input type="text" name="rank3" size="3" maxlength="5" style="text-align:right" value="-100" />00-<input type="text" name="rank4" size="3" maxlength="5" style="text-align:right" value="-300" />00 (最大100,000点 ~ 最小-100,000点)</dd>
 ...
 <dt> 公開設定</dt>
<dd> <input type="radio" id="show_yes" name="show" value="yes" checked>
  <label for="show_yes">全員に公開する</label> 
   <input type="radio" id="show_no" name="show" value="no">
  <label for="show_no">全員に公開しない</label></dd>
<dd><span id="vpass">閲覧パスワード</span>：<input type="password" name="password_view" size=15" maxlength="16" /></dd>
<dd><span id="vpass">閲覧パスワード(確認)</span>：<input type="password" name="password_view_c" size=15" maxlength="16" /></dd>
